-- CreateEnum
CREATE TYPE "AttachmentType" AS ENUM ('PHOTO', 'RECEIPT', 'WARRANTY');
...
CREATE TABLE "UserPreferences" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "warrantyNotificationsEnabled" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE INDEX "Item_userId_warrantyExpiration_idx" ON "Item"("userId", "warrantyExpiration");
